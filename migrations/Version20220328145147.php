 ...
 */
final class Version20220328145147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE seance_entrainement (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, title VARCHAR(50) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, all_day TINYINT(1) DEFAULT NULL, background_color VARCHAR(7) DEFAULT NULL, INDEX IDX_43470E364DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
