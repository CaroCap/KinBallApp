 ...
 */
final class Version20220329102249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation_entrainement (id INT AUTO_INCREMENT NOT NULL, seance_id INT DEFAULT NULL, user_id INT NOT NULL, type_presence VARCHAR(20) DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_9E2D7FE5E3797A94 (seance_id), INDEX IDX_9E2D7FE5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saison (id INT AUTO_INCREMENT NOT NULL, debut DATETIME NOT NULL, fin DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE seance (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, rue VARCHAR(255) DEFAULT NULL, numero VARCHAR(20) DEFAULT NULL, code_postal VARCHAR(20) DEFAULT NULL, ville VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participation_entrainement ADD CONSTRAINT FK_9E2D7FE5E3797A94 FOREIGN KEY (seance_id) REFERENCES seance (id)');
        $this->addSql('ALTER TABLE participation_entrainement ADD CONSTRAINT FK_9E2D7FE5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation_entrainement DROP FOREIGN KEY FK_9E2D7FE5A76ED395');
