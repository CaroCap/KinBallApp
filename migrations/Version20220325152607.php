 ...
 */
final class Version20220325152607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, player_id INT NOT NULL, saison VARCHAR(20) NOT NULL, jour_entrainement VARCHAR(30) NOT NULL, date_inscription DATETIME NOT NULL, paiement TINYINT(1) NOT NULL, date_paiement DATETIME DEFAULT NULL, fiche_medicale VARCHAR(255) DEFAULT NULL, certif_medical VARCHAR(255) DEFAULT NULL, INDEX IDX_5E90F6D6BCF5E72D (categorie_id), INDEX IDX_5E90F6D699E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
