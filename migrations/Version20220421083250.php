 ...
 */
final class Version20220421083250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT AUTO_INCREMENT NOT NULL, saison_id INT NOT NULL, categorie_id INT DEFAULT NULL, title VARCHAR(50) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, numero VARCHAR(20) DEFAULT NULL, rue VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(20) DEFAULT NULL, ville VARCHAR(150) DEFAULT NULL, INDEX IDX_DF7DFD0EF965414C (saison_id), INDEX IDX_DF7DFD0EBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, genre TINYINT(1) DEFAULT NULL, email VARCHAR(200) NOT NULL, telephone VARCHAR(20) NOT NULL, date_naissance DATE DEFAULT NULL, rue VARCHAR(255) DEFAULT NULL, numero VARCHAR(20) DEFAULT NULL, code_postal VARCHAR(20) DEFAULT NULL, ville VARCHAR(150) DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, accord_photo TINYINT(1) NOT NULL, pers_contact_nom VARCHAR(50) DEFAULT NULL, pers_contact_tel VARCHAR(20) DEFAULT NULL, pers_contact_mail VARCHAR(200) DEFAULT NULL, date_update DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
